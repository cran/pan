...
The reference should read\footnote{Note that the technical report was originally obtained from 
\url{http://www.stat.psu.edu/reports/1997/tr9704.pdf}}

\vskip 0.25cm

Schafer, J.L. (1997) Imputation of missing covariates under a multivariate linear mixed model. Technical report 97-04, 
Dept. of Statistics, The Pennsylvania State University, \url{http://stat.psu.edu/Research/archived-technical-reports}.
